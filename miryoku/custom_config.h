...
U_MTTL(LGUI, A),     U_MTTL(LALT, S),     U_MTTL(LCTRL, D),    U_MTTL(LSHFT, F),    &kp G,             &kp H,             U_MTTR(LSHFT, J),    U_MTTR(LCTRL, K),    U_MTTR(LALT, L),     U_MTTR(LGUI, SQT),   \
U_LT(U_BUTTON, Z), U_MTTL(RALT, X),     &kp C,             &kp V,             &kp B,             &kp N,             &kp M,             &kp COMMA,         U_MTTR(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_MEDIA, ESC),U_LT(U_NAV, SPACE),U_LT(U_MOUSE, TAB),U_LT(U_FUN, RET),  U_LT(U_NUM, BSPC), LSHIFT,  U_NP,              U_NP
...
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              &kp RET,           &kp BSPC,          &kp LSHIFT,           U_NP,              U_NP
...
U_NP,              U_NP,              &kp K_APP,         &kp SPACE,         &kp TAB,           DEL,              U_NA,              U_NA,              U_NP,              U_NP
